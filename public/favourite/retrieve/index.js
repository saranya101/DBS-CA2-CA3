    ...
    function displayProducts(products) {
        ...
        products.forEach(product => {
            ...
            productElement.innerHTML = `
                ...
                <img src="${product.productImageUrl || 'default-image.jpg'}" alt="${product.productName || 'Product Image'}" />
        ...
        document.querySelectorAll('.remove-btn').forEach(button => {
            button.addEventListener("click", function () {
                ...
                console.log(`Delete button clicked for product_id: ${productId}`);
                window.location.href = `../remove/index.html?listId=${listId}&productId=${productId}`;
            });
        });
